...
<head>
    ...
    <title>{$companyname} - INVOICE {$pagetitle}</title>
        ...
        {else}
            ...
            <div class="row invoice-header">
                <div class="col-12 col-sm-6 justify-content-sm-between text-center text-sm-left invoice-col">
                    ...
                    {if $logo}
                        <p><a href="https://raphus.mu/clientarea.php?action=invoices"><img src="{$logo}" title="{$companyname}" /></a></p>
                    {else}
                        <h4>{$companyname}</h4>
                    {/if}
                    <h5>{$pagetitle}</h5>
            ...
            <div class="card bg-default">
                <div class="card-header">
                    <h5 class="card-title mb-0 font-size-24"><strong>{lang key='invoicelineitems'}</strong></h5>
                </div>
