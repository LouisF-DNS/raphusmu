                                    ...
                                    {foreach $featuredTlds as $num => $tldinfo}
                                        {if $num < 3}
                                            <li class="list-inline-item">
                                                <img src="{$BASE_PATH_IMG}/tld_logos/{$tldinfo.tldNoDots}.png" alt="fds">
                                                <span>
                                    ...
                                    <ul class="list-inline tt-domain-list text-white mb-0 d-none d-lg-block d-xl-block">
                                        {foreach $pricetable as $price}
                                            {if $price.extension == '.com'}
                                                <li class="list-inline-item"><img src="{$WEB_ROOT}/templates/{$template}/img/com.png" alt="com" width="65" class="img-fluid"> <span>{$price.prefix}{$price.msetupfee}</span></li>
                                            {elseif $price.extension == '.net'}
                                                <li class="list-inline-item"><img src="{$WEB_ROOT}/templates/{$template}/img/net.png" alt="net" width="65" class="img-fluid"> <span>{$price.prefix}{$price.msetupfee}</span></li>
                                            {elseif $price.extension == '.org'}
                                                <li class="list-inline-item"><img src="{$WEB_ROOT}/templates/{$template}/img/org.png" alt="org" width="65" class="img-fluid"> <span>{$price.prefix}{$price.msetupfee}</span></li>
                                            {elseif $price.extension == '.store'}
                                                <li class="list-inline-item"><img src="{$WEB_ROOT}/templates/{$template}/img/store.png" alt="store" width="65" class="img-fluid"> <span>{$price.prefix}{$price.msetupfee}</span></li>
                                            {elseif $price.extension == '.online'}
                                                <li class="list-inline-item"><img src="{$WEB_ROOT}/templates/{$template}/img/online.png" alt="online" width="65" class="img-fluid"> <span>{$price.prefix}{$price.msetupfee}</span></li>
                                            {/if}
                                        {/foreach}
                                    </ul>
                                {/if}
                            {/if}
                            <a href="{routePath('domain-pricing')}" class="tt-read-more float-right">
                                Domain Pricing <i class="fad fa-arrow-right"></i></a>
                        </div>
