                ...
                {if $registerdomainenabled}
                    <div class="col-lg-6">
                        <div class="bg-white p-4 d-flex align-items-center justify-content-between tt-rounded mt-4">
                            ...
                            <img src="{$WEB_ROOT}/templates/{$template}/img/icon-domain-1.png" width="65" class="img-fluid" alt="support image">
                        </div>
                    </div>
                {/if}
                {if $transferdomainenabled}
                    <div class="col-lg-6">
                        <div class="bg-white p-4 d-flex align-items-center justify-content-between tt-rounded mt-4">
                            ...
                            <img src="{$WEB_ROOT}/templates/{$template}/img/icon-domain-2.png" width="65" class="img-fluid" alt="support image">
                        </div>
                    </div>
                {/if}
            </div>
