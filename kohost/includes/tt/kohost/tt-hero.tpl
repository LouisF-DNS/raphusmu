                ...
                <div class="col-lg-6">
                    <div class="tt-hero text-white">
                        ...
                        <div class="tt-hero-btns">
                            <a href="index.php?rp=/store/web-hosting" class="btn btn-primary mr-3 page-scroll">Get started!</a>
                            <a href="index.php?rp=/domain/pricing" class="btn btn-outline-light page-scroll">View Pricing</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
