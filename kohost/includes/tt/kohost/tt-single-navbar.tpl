                            ...
                            {foreach $multiCurrency as $currency}
                                {if $currency.id eq $selectedCurrency}
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                        ...
                                        <span>{$currency.suffix}</span> <b class="caret"></b>
                                    </a>
                                {/if}
                            {/foreach}
                                ...
                                {foreach $multiCurrency as $currency}
                                    {if $currency.id neq $selectedCurrency}
                                        {if $isQueryExist eq true}
                                            <li><a href="{$urlForCurrentcy}&currency={$currency.id}">{*<img alt="{$currency.code}" src="{$WEB_ROOT}/{$currency.flag}" class="tt-country-flag">*}<span>{$currency.suffix}</span></a></li>
                                        {else}
                                            <li><a href="{$urlForCurrentcy}?currency={$currency.id}">{*<img alt="{$currency.code}" src="{$WEB_ROOT}/{$currency.flag}" class="tt-country-flag">*}<span>{$currency.suffix}</span></a></li>
                                        {/if}
                                    {/if}
