...
<div class="tt-form-wrap">
    <form method="post" action="{routePath('login-validate')}" class="login-form" role="form">
        <div class="tt-form-container">
            <div class="tt-form-content">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="email" class="form-control" name="username" id="inputEmail" placeholder="name@raphus.mu" autofocus>
                    </div>
                </div>
                ...
                <div class="mt-3 d-flex align-items-center justify-content-between">
                    <p class="mb-0">{lang key='userLogin.notRegistered'} <br><a href="{$WEB_ROOT}/register.php">{lang key='userLogin.createAccount'}</a></p>
            ...
            <div class="tt-login-registration-testimonial" style="background: url('{$WEB_ROOT}/templates/{$template}/img/tt-login-testimonial-bg3.jpg')no-repeat center bottom / cover">
