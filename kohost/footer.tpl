               ...
               <div class="row">
                   <div class="col-lg-3 col-md-6">
                       <div class="tt-footer-widget">
                           <h6 class="text-white">Raphus Ltd</h6>
                           <address class="mt-3">
                               The Mezza Business Hub B16<br>
                               Domaine Mont Calme<br>
                               11602<br>
                               Tamarin, Mauritius<br>
                               {*<abbr title="Phone">P: (+230) 5 853 4223</abbr>*}
                           </address>
                   ...
                   <div class="col-lg-3 col-md-6">
                       <div class="tt-footer-widget">
                           <h6 class="text-white">Products & Services</h6>
                            <ul class="list-unstyled tt-footer-menu mt-3">
                                <li><a href="{$WEB_ROOT}/cart.php?a=add&domain=register">Domain Registration</a></li>
                                <li><a href="{$WEB_ROOT}/cart.php?a=add&domain=transfer">Domain Transfer</a></li>
                                <li><a href="{$WEB_ROOT}/index.php?rp=/store">Web Hosting</a></li>
                                <li><a href="{$WEB_ROOT}/wd.php">Web Development and Design</a></li>
                                <li><a href="{$WEB_ROOT}/index.php?rp=/store/ssl-certificates">SSL Certificates</a></li>
                                <li><a href="{$WEB_ROOT}/index.php?rp=/store/nordvpn">NordVPN</a></li>
                   ...
                   <div class="col-lg-3 col-md-6">
                       <div class="tt-footer-widget">
                           ...
                           <ul class="list-unstyled tt-footer-menu mt-3">
                               ...
                               <li><a href="{$WEB_ROOT}/index.php?rp=/announcements">News</a></li>
                               <li><a href="{$WEB_ROOT}/privacy.php">Privacy Policy</a></li>
                               {if $acceptTOS}
                                   <li>
                                       <a href="{$tosURL}">{lang key='ordertos'}</a>
                                   </li>
                               {/if}
                               <li><a href="{$WEB_ROOT}/about-us.php">{lang key='aboutus'}</a></li>
